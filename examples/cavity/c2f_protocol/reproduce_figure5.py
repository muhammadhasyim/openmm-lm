...
Run via pixi:
    pixi run -e test python examples/cavity/c2f_protocol/reproduce_figure5.py
    pixi run -e test python examples/cavity/c2f_protocol/reproduce_figure5.py --quick
