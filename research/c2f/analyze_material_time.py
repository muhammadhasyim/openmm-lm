...
Usage:
  python analyze_material_time.py \
      --relaxation-file ../../../third_party/cav-hoomd/relaxation_times_vs_temperature.txt \
...
DEFAULT_RELAX = _SCRIPT_DIR.parents[2] / "third_party/cav-hoomd" / "relaxation_times_vs_temperature.txt"
