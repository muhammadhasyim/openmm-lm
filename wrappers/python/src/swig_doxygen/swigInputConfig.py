...
("CavityForce", "getCouplingModulationType") : (None, ()),
("CavityForce", "setCouplingModulation") : (None, (None, None, "unit.picosecond", None, "unit.picosecond", "unit.picosecond", "unit.picosecond")),
("CavityForce", "getModulationAmplitude") : (None, ()),
("CavityForce", "getModulationPeriodPs") : ("unit.picosecond", ()),
("CavityForce", "getModulationDutyCycle") : (None, ()),
("CavityForce", "getModulationStartTimePs") : ("unit.picosecond", ()),
("CavityForce", "getModulationStopTimePs") : ("unit.picosecond", ()),
("CavityForce", "getModulationDecayTauPs") : ("unit.picosecond", ()),
("CavityForce", "setAdaptiveSquareWaveModulation") : (None, (None, "unit.kelvin", "unit.picosecond", None, "unit.picosecond", "unit.picosecond", None, None)),
("CavityForce", "setDecayingSquareWaveModulation") : (None, (None, "unit.picosecond", None, None, "unit.picosecond", "unit.picosecond", None)),
("CavityForce", "setSinusoidModulation") : (None, (None, "unit.picosecond", None, "unit.picosecond", "unit.picosecond")),
("CavityForce", "setExponentialWaveModulation") : (None, (None, "unit.picosecond", "unit.picosecond", "unit.picosecond", "unit.picosecond")),
("CavityForce", "getModulationTargetTemperatureK") : ("unit.kelvin", ()),
("CavityForce", "getModulationMinAmplitude") : (None, ()),
("CavityForce", "getModulationMaxAmplitude") : (None, ()),
("CavityForce", "getModulationExtraParam1") : (None, ()),
("*", "getModulationPeriodPs") : ("unit.picosecond", ()),
("*", "getModulationStartTimePs") : ("unit.picosecond", ()),
("*", "getModulationStopTimePs") : ("unit.picosecond", ()),
("*", "getModulationDecayTauPs") : ("unit.picosecond", ()),
("*", "getModulationTargetTemperatureK") : ("unit.kelvin", ()),
("*", "getModulationAmplitude") : (None, ()),
("*", "getModulationDutyCycle") : (None, ()),
("*", "getModulationMinAmplitude") : (None, ()),
("*", "getModulationMaxAmplitude") : (None, ()),
("*", "getModulationExtraParam1") : (None, ()),
("MultiModeCavityForce", "setAdaptiveSquareWaveModulation") : (None, ("unit.picosecond", None, "unit.picosecond", "unit.picosecond")),
("MultiModeCavityForce", "setModeModulationParams") : (None, (None, None, "unit.kelvin", None, None)),
("MultiModeCavityForce", "getModeGTarget") : (None, ()),
("MultiModeCavityForce", "getModeTTargetK") : ("unit.kelvin", ()),
("MultiModeCavityForce", "getModeMinAmplitude") : (None, ()),
("MultiModeCavityForce", "getModeMaxAmplitude") : (None, ()),
("MultiModeCavityForce", "isModulationEnabled") : (None, ()),
...
("RPMDStochasticCellRescalingBarostat", "getDefaultPressure") : ("unit.bar", ()),
("RPMDStochasticCellRescalingBarostat", "setDefaultPressure") : (None, ("unit.bar",)),
...
("RPMDStochasticCellRescalingBarostat", "getIsothermalCompressibility") : (None, ()),
("RPMDStochasticCellRescalingBarostat", "setIsothermalCompressibility") : (None, (None,)),
("RPMDStochasticCellRescalingBarostat", "getFrequency") : (None, ()),
("RPMDStochasticCellRescalingBarostat", "setFrequency") : (None, (None,)),
("RPMDStochasticCellRescalingBarostat", "getScaleVelocities") : (None, ()),
("RPMDStochasticCellRescalingBarostat", "setScaleVelocities") : (None, (None,)),
("RPMDStochasticCellRescalingBarostat", "getRandomNumberSeed") : (None, ()),
("RPMDStochasticCellRescalingBarostat", "setRandomNumberSeed") : (None, (None,)),
